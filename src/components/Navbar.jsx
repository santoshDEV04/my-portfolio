...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav
        ref={navbarRef}
        className={`Navbar fixed top-0 left-0 right-0 pt-1 w-full max-w-screen z-50 transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              ...
              {/* <div className="hidden sm:block">
                <h1 className="text-white text-xl font-bold tracking-tight text-glow">
                  Santosh
                </h1>
