...
// Simplified floating blob with reduced animations
const FloatingBlob = ({
  radius = 60,
  duration = 20,
  size = "w-16 h-16",
...
// Simplified text animation using Framer Motion
        ...
        >
          ...
          <div className="space-y-4">
            {educationJourney.map((edu, index) => (
              ...
              >
                <div
                  className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-b from-cyan-700/30 hover:scale-105 
                               transition-all duration-300"
                >
                  <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {motivations.map((item, index) => (
            <AnimatedText
              key={index}
              delay={0.1 + index * 0.1}
              className="p-4 rounded-xl bg-gradient-to-b from-sky-800/60 hover:scale-3d hover:scale-y-110
                          transition-all duration-300"
            >
